...
<!-- Header Banner -->
![Header](https://capsule-render.vercel.app/api?type=waving&color=00d4aa&height=200&section=header&text=Sameer%20%7C%20Markhore007&fontSize=40&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=Full%20Stack%20Developer%20%7C%20Computer%20Vision%20Engineer&descAlignY=55&descSize=16)
...
|---------|-------------|-------|
| 🔍 **QueryForge** | AI-powered SQL query generator — natural language to SQL | Next.js, Prisma, PostgreSQL, Docker |
| 🚗 **Vehicle Tracker** | Real-time detection & tracking with YOLOv8 + BoT-SORT | Python, OpenCV, YOLOv8 |
| 🐾 **PetCareAI** | Smart pet care platform with AI health tracking | React, Node.js, MongoDB |
| 📚 **PrepPath AI** | PPSC/CSS exam prep portal with AI analytics | React, Express, MongoDB |
